...
Cow::Cow(const string& tongue, const string& fname) 
    : ASCIIPicture("./cows/" + fname + ".cow"), tongue(tongue)
{
}

Cow::~Cow() {}

void Cow::print(unsigned int left, char fill, unsigned int width) override
{
