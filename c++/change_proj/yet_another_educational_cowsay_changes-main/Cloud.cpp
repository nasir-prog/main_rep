...
Cloud::Cloud(const string& message, const string& fname) 
    : ASCIIPicture("./clouds/" + fname + ".cloud"), message(message)
{
}

Cloud::~Cloud() {}

void Cloud::print(unsigned int left, char fill, unsigned int width) override
{
